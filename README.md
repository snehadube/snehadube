...
* 🚀 **Multi-Domain Resume Auditor Pro** — Full-stack tool parsing PDF data with rule-based analytics.
* 📊 **HR Analytics Dashboard** — *(Coming Soon)* Analyzing talent trends using Power BI and data pipelines.

---

⚡ *Fun fact: I love reading raw server logs and fixing cloud container deployment bugs live!*
